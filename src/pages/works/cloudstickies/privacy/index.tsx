...
const Component: React.FC = () => {
  useDocumentMeta({
    title: "Privacy Policy — Cloud Stickies | Karaage's Library",
    description:
      "Privacy Policy for Cloud Stickies, an iCloud-synced sticky notes app for macOS. Learn how the app handles your notes, iCloud sync, automatic updates, and contact information.",
    canonical: "https://krgpi.github.io/works/cloudstickies/privacy",
    ...
    <div className="max-w-(--breakpoint-xl) mx-auto px-4 py-8 space-y-6">
      <header className="space-y-2 max-w-prose">
        <p className="text-sm text-gray-500">
          ...
          >
            ← Back to Cloud Stickies
          </a>
        </p>
        <h1 className="text-3xl sm:text-4xl font-light">
          Cloud Stickies — Privacy Policy
        </h1>
      ...
      <article className="max-w-prose space-y-6 leading-relaxed">
        <section className="space-y-2">
          <p>
            This Privacy Policy explains how <strong>Cloud Stickies</strong>{" "}
            ...
            <a
              href="https://krgpi.github.io/works/cloudstickies"
              className="text-krg-link-orange hover:underline"
            >
              krgpi.github.io
            </a>
          ...
          <p>
            <strong>Summary:</strong> Cloud Stickies does not collect, transmit,
        ...
        <section className="space-y-2">
          ...
          <p>
            Cloud Stickies stores the content you type into sticky notes —
        ...
        <section className="space-y-2">
          ...
          <p>
            ...
            enabled, Cloud Stickies uses Apple’s CloudKit framework to sync
        ...
        <section className="space-y-2">
          ...
          <p>
            Cloud Stickies uses the open-source{" "}
            <a
        ...
        <section className="space-y-2">
          ...
          <p>
            Cloud Stickies does not include any third-party crash-reporting or
        ...
        <section className="space-y-2">
          ...
          <p>
            Cloud Stickies is a general-purpose productivity app and is not
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              You can uninstall Cloud Stickies by dragging{" "}
              <code>Cloud Stickies.app</code> from <code>/Applications</code>{" "}
              to the Trash.
            </li>
          </ul>
        </section>
